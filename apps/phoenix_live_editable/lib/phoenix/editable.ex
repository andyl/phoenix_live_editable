defmodule Phoenix.Editable do
  ...
  attr :ple_focus, :string, doc: "Target for focus handler"
  attr :ple_save, :string, doc: "Target for save handler"
  attr :ple_change, :string, doc: "Target for validation handler"
