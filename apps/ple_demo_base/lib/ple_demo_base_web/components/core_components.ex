defmodule PleDemoBaseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PleDemoBaseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PleDemoBaseWeb.Gettext, "errors", msg, opts)
    end
  end
