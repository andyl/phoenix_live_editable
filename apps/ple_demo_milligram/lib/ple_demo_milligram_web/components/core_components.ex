defmodule PleDemoMilligramWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PleDemoMilligramWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PleDemoMilligramWeb.Gettext, "errors", msg, opts)
    end
  end
